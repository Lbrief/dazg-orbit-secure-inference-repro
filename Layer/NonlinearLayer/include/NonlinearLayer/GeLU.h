...
// Component: Layer/NonlinearLayer/include/NonlinearLayer/GeLU.h
...
#ifndef DAZG_ORBIT_ENABLE_GELU_DEBUG_CHECK_SHARE
        // DAZG_ORBIT_V743R8P67_GELU_DEBUG_CHECK_SHARE_GUARD:
        // Default no-op for paper-grade secure-shadow attempts.
        // The original check_share() reconstructs and prints shares for debugging;
        // enabling it requires -DDAZG_ORBIT_ENABLE_GELU_DEBUG_CHECK_SHARE.
        (void)x;
        (void)mod;
        (void)name;
        return;
