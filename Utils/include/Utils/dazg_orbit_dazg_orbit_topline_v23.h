...
// Component: Utils/include/Utils/dazg_orbit_dazg_orbit_topline_v23.h
...
inline bool Enabled() {
    if (AnyExplicitFalse("DAZG_ORBIT_TOPLINE_V23",
                         "DAZG_ORBIT_TOPLINE_V23",
                         "DAZG_ORBIT_TOPLINE_V23",
                         "DAZG_ORBIT_CERTCASCADE_V23",
                         "DAZG_ORBIT_CERTPATH_V23")) {
        return false;
    }
    return AnyExplicitTrue("DAZG_ORBIT_TOPLINE_V23",
                           "DAZG_ORBIT_TOPLINE_V23",
                           "DAZG_ORBIT_TOPLINE_V23",
                           "DAZG_ORBIT_CERTCASCADE_V23",
                           "DAZG_ORBIT_CERTPATH_V23");
...
inline const char* Profile() {
    const char* p = GetenvAny("DAZG_ORBIT_TOPLINE_V23_PROFILE",
                              "DAZG_ORBIT_TOPLINE_V23_PROFILE",
                              "DAZG_ORBIT_TOPLINE_V23_PROFILE",
                              "DAZG_ORBIT_CERTCASCADE_V23_PROFILE",
                              "DAZG_ORBIT_CERTPATH_V23_PROFILE");
...
inline void PrintConfigOnce(int role) {
    ...
    const bool component_runtime_enabled =
        Enabled() || EnableThunderAct() || EnableFanoutBurst() || EnableDomainPulseV15();
    std::cerr << "[DAZG_ORBIT_TOPLINE_V23]"
